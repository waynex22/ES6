            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <div className="">
                        ...
                        <label for="card-holder" className="mt-4 mb-2 block text-sm font-medium bg-gradient-to-r from-mint to-blue-400 bg-clip-text text-transparent">Card Holder</label>
                        <div className="relative">
                        ...
                        <label for="card-no" className="mt-4 mb-2 block text-sm font-medium bg-gradient-to-r from-mint to-blue-400 bg-clip-text text-transparent">Card Details</label>
                        <div className="flex">
                        ...
                        <label for="billing-address" className="mt-4 mb-2 block text-sm font-medium bg-gradient-to-r from-mint to-blue-400 bg-clip-text text-transparent">Billing Address</label>
                    ...
                    <button className="mt-4 mb-8 w-full rounded-md bg-mint px-6 py-3 font-medium text-white">Place Order</button>
                </div>
            </div>
