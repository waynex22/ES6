...
const Contact = () => {
  ...
  <section class="mx-auto max-w-screen-xl md:rounded-md md:border md:shadow-lg">
    <div class="grid grid-cols-4 bg-gradient-to-r from-mint to-blue-400 bg-clip-text text-transparent lg:grid-cols-3">
      <div class="col-span-4 bg-gray-50 px-8 py-10 bg-gradient-to-r from-mint to-blue-400 bg-clip-text text-transparent md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        <h2 class="mb-8 text-2xl font-black">Contact me</h2>
        <ul>
          <li class="mb-6 flex items-start text-left">
            <svg class="shrink-0 mr-6 text-2xl text-mint" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5l-8-5V6l8 5l8-5v2z" /></svg>
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="#">khaipnpd07148@fpt.edu.vn</a>
          ...
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="#">Waynex22</a>
          ...
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <p class="font-serif text-base md:text-lg">Waynex22</p>
      ...
      <div class="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
        ...
        <form action="">
          ...
          <button type="submit" class="group flex cursor-pointer items-center rounded-xl bg-mint bg-none px-8 py-4 text-center font-semibold leading-tight text-white">
            Send
