...
const CategoryAdmin = () => {
  ...
  return (
    <div className='container mx-auto py-8'>
            <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-4xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Categorys</span> Mananger</h1>
            <div className='mb-8'>
                <Link to='/AddCategory' class="px-5 py-2.5 relative rounded group text-white font-medium inline-block">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        {categorys.map((category) => (
                            <tr key={category.id} class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 flex justify-between items-center mt-4">
                                    <Link to={`/updatecategory/${category.id}`} className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</Link>
                                    <button
